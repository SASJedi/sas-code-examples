...
%macro listFiles(directory,outVar);
   ...
   %let fileref=thisDir;
   /* Use the %SYSFUNC function to execute the sourceFile function, assigning the 
   ...
   /* Use the %SYSFUNC function to execute the sourceFile function to clear the fileref. */
   %let rc=%sysfunc(filename(fileref));
...
%macro copyFile(sourceFile,from,to,destinationFile);
   ...
   /* Use the %SYSFUNC function to execute the sourceFile function, assigning the source
   ...
   /* Use the %SYSFUNC function to execute the sourceFile function, assigning the dest
