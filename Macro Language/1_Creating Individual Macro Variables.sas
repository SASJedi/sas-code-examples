/************************************************************************************************
 Creating User-Defined Macro Variables
    Example of three different ways to create macro variables.
...
/************************************************************************************************
 2. Creating macro variables using PROC SQL
    ...
    b. The INTO clause inserts the result of a column into the macro in the same position on the 
       variable list. A colon must precede each macro variable name. The TRIMMED operator 
       removes all leading and trailing blanks before storing the value in the macro variable. 
